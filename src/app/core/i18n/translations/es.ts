...
export const es = {
  ...
  players: {
    ...
    matchReasons: {
      availability: 'Las disponibilidades encajan bien',
      level: 'Mismo nivel de juego',
      activity: 'Nivel de actividad parecido en Rally',
      coaching: 'Rutinas de entrenamiento parecidas',
      frequency: 'Misma frecuencia de juego',
      format: 'Los formatos preferidos encajan bien',
      surface: 'Misma superficie preferida',
      location: 'Misma ciudad',
      courtPref: 'Las preferencias de pista encajan bien',
      default: 'Calculado a partir de los perfiles de jugador'
    },
    ...
    matchesMoreResults: 'Hay {n} más que no se muestran aquí.',
    ...
    aboutPlayerEyebrow: 'Sobre el jugador',
  ...
  feed: {
    ...
    reportLead: '¿Por qué lo denuncias? Nadie sabrá que fuiste tú.',
    reportThanks: 'Gracias. Denuncia registrada.',
    reportFailed: 'No se pudo registrar la denuncia.',
    alreadyReported: 'Ya has denunciado esta publicación.',
    reportReasons: {
      spam: 'Es spam',
    ...
    publicCtaCreate: 'Crear cuenta',
    publicCtaLogin: 'Ya tengo cuenta',
    postNotFoundTitle: 'Publicación no encontrada',
    postNotFoundBody: 'Puede que el autor haya eliminado esta publicación.',
    postNotFoundAction: 'Ir a RALLY',
    ...
    deletePostFailed: 'No se pudo eliminar la publicación.',
    loadMore: 'Cargar más',
    loadingMore: 'Cargando…',
    newPosts: 'Publicaciones nuevas',
    trip: {
      ownHeadline: '¡Me voy de viaje!',
      otherHeadline: '¡{name} se va de viaje!',
      destinationLabel: 'Destino',
      datesLabel: 'Fecha'
    },
    venue: {
      ownHeadline: '¡Descubrí una pista nueva!',
      otherHeadline: '¡{name} descubrió una pista nueva!',
      courtLabel: 'Pista',
      locationLabel: 'Ubicación',
      seeCourt: 'Ver la pista'
    },
    match: {
      ownHeadline: '¡Abrí un partido!',
      otherHeadline: '¡{name} abrió un partido!',
      locationLabel: 'Ubicación',
      dateLabel: 'Fecha',
      join: 'Quiero jugar',
  ...
  auth: {
    ...
    errorProfileSave: 'Tu cuenta fue creada, pero no fue posible guardar tu perfil. Inténtalo de nuevo.',

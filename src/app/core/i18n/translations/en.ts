export const en = {
  ...
  players: {
    ...
    matchReasons: {
      availability: 'Schedules line up well',
      level: 'Same skill level',
      activity: 'Similar activity level on Rally',
      coaching: 'Similar coaching routines',
      frequency: 'Same playing frequency',
      format: 'Preferred formats fit together',
      surface: 'Same preferred surface',
      location: 'Same city',
      courtPref: 'Court preferences fit together',
      default: 'Calculated from player profiles'
    },
  ...
  courts: {
    ...
    countriesWithCourts: 'Countries',
    venuesStat: 'Places',
    indoorShareStat: 'Indoor',
    myCapturesStat: 'Captures',
  ...
  matches: {
    ...
    composerDialogTitle: 'New match',
    composerHeadline: 'Get a game on the books',
  ...
  feed: {
    ...
    reportLead: "Why are you reporting this? Nobody will know it was you.",
    reportThanks: 'Thanks. Report filed.',
    reportFailed: "Couldn't file the report.",
    alreadyReported: 'You have already reported this post.',
    reportReasons: {
      spam: "It's spam",
      inappropriate: 'Inappropriate content',
      harassment: 'Harassment or a personal attack',
    ...
    publicCtaCreate: 'Create account',
    publicCtaLogin: 'I have an account',
    postNotFoundTitle: 'Post not found',
    postNotFoundBody: 'This post may have been deleted by its author.',
    postNotFoundAction: 'Go to RALLY',
    ...
    newPosts: 'New posts',
    trip: {
      ownHeadline: "I'm going on a trip!",
      otherHeadline: '{name} is going on a trip!',
      destinationLabel: 'Destination',
      datesLabel: 'Dates'
    },
    venue: {
      ownHeadline: 'I discovered a new court!',
      otherHeadline: '{name} discovered a new court!',
      courtLabel: 'Court',
      locationLabel: 'Location',
      seeCourt: 'See the court'
    },
    match: {
      ownHeadline: 'I opened a match!',
      otherHeadline: '{name} opened a match!',
      locationLabel: 'Location',
      dateLabel: 'Date',
      join: 'I want to play',

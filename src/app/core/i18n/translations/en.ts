export const en = {
  ...
  auth: {
    ...
    maxDistanceSliderQuestion: 'Maximum distance you are willing to travel',
    locationPermissionQuestion: 'Can we use your location?',
    locationPermissionHint: 'Helps us suggest players and courts closer to you. You can always change this later.',
